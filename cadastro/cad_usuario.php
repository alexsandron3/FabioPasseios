<?php
session_start();
// Checa se o usuário está logedo, se não, redireciona ele para a página de login.
		...
		<div class="container-fluid	 form-group col-lg-12 col-sm-8">
			...
			<div class="col-lg-8 form-group">
				<form class="form-group" method="POST" action="proc_cad_usuario.php">
					...
					<label></label>
						<input  class="form-control col-lg-4" type="date" name="data_nascimento" placeholder="DATA DE NASCIMENTO" > <br><br>
					<label></label>
